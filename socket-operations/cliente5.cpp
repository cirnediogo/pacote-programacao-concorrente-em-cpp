...
// programa cliente5.cp --> ler uma estrutura
...
int main( )
{
   ...
   address.sin_addr.s_addr = inet_addr("10.13.100.182"); //euler
  ...
  pessoa1.idade = 20;
  strcpy(pessoa1.nome, "Diogo CIRNE");
  write(sockfd,  &pessoa1,sizeof(pessoa1));
  read(sockfd, &pessoa2,sizeof(pessoa2));
